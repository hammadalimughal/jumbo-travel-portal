      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          form.setFieldsValue({
            ...
            extra_services: qData.extra_services && qData.extra_services.length > 0 ? qData.extra_services : ['Air Ticket', 'Hotels']
          });
      ...
      >
        ...
        <Form.Item noStyle dependencies={['extra_services']}>
          {() => {
            ...
            if (bookingType === 'Individual' && !extraServices.includes('Air Ticket')) return null;
            return (
